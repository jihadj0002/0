...
class Conversation(models.Model):
    ...
    profile_image = models.ImageField(upload_to="customer_profiles", default="customer.jpg", null=True, blank=True)
    ...
    current_product = models.CharField(max_length=2500, blank=True, null=True)
